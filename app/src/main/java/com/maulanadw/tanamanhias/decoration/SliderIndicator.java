package com.maulanadw.tanamanhias.decoration;
...
public class SliderIndicator implements ViewPager.OnPageChangeListener {
    ...
    public SliderIndicator(@NonNull Context context,
                           @NonNull LinearLayout continerView,
                           @NonNull ViewPager viewPager,
                           @DrawableRes int drawableRes) {

        if (context == null) {
            throw new IllegalArgumentException("context cannot be null");
        } else if (continerView == null) {
            ...
            throw new IllegalArgumentException("ViewPager does'nt have an adapter set on it.");
        }

        mContext = context;
        mContainer = continerView;
